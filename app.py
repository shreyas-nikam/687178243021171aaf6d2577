...
- **Risk Status (RAG):** Color-coded system for immediate risk assessment:
    - 🟢 `Green`: Exposure ≤ Allocated Appetite (Safe zone - all good!)
    - 🟡 `Amber`: Allocated Appetite < Exposure ≤ Absolute Risk Tolerance (Caution zone - monitor closely)
    - 🔴 `Red`: Exposure > Absolute Risk Tolerance (Danger zone - immediate action required!)
